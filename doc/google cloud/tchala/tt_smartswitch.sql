...
--
-- Host: localhost    Database: tt_smartswitch
-- ------------------------------------------------------
...
--
-- Table structure for table `tt_deposit_type`
--

DROP TABLE IF EXISTS `tt_deposit_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_deposit_type` (
...
--
-- Dumping data for table `tt_deposit_type`
--

LOCK TABLES `tt_deposit_type` WRITE;
/*!40000 ALTER TABLE `tt_deposit_type` DISABLE KEYS */;
INSERT INTO `tt_deposit_type` VALUES (1,'','CASH'),(2,'','BANK_DEPOSIT'),(3,'','CREDIT_CARD'),(4,'','DEBIT_CARD'),(5,'','BANK_TRANSFER');
/*!40000 ALTER TABLE `tt_deposit_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_distribution_channel`
--

DROP TABLE IF EXISTS `tt_distribution_channel`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_distribution_channel` (
...
--
-- Dumping data for table `tt_distribution_channel`
--

LOCK TABLES `tt_distribution_channel` WRITE;
/*!40000 ALTER TABLE `tt_distribution_channel` DISABLE KEYS */;
INSERT INTO `tt_distribution_channel` VALUES (1,'','RECEIPT'),(2,'','SMS');
/*!40000 ALTER TABLE `tt_distribution_channel` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_import_batch`
--

DROP TABLE IF EXISTS `tt_import_batch`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_import_batch` (
  ...
  CONSTRAINT `FKaflv1bnsselrb3r8yui9ry745` FOREIGN KEY (`voucher_id`) REFERENCES `tt_voucher` (`voucher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_import_batch`
--

LOCK TABLES `tt_import_batch` WRITE;
/*!40000 ALTER TABLE `tt_import_batch` DISABLE KEYS */;
INSERT INTO `tt_import_batch` VALUES (1,'VOUCHER_BATCH_20161118_10000.TXT','2017-09-09 11:03:41',45,'10000',1),(2,'Voms020715_173154.dec','2017-09-11 11:32:23',50,'173154',14);
/*!40000 ALTER TABLE `tt_import_batch` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_incoming_payment`
--

DROP TABLE IF EXISTS `tt_incoming_payment`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_incoming_payment` (
  ...
  CONSTRAINT `FKagiy2d4v6p1ejotljk0uoqc71` FOREIGN KEY (`deposit_type_id`) REFERENCES `tt_deposit_type` (`deposit_type_id`),
  CONSTRAINT `FKefuhydxuvffi37ewyfksc3bfw` FOREIGN KEY (`bank_id`) REFERENCES `symbiosis_bank` (`bank_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_incoming_payment`
--

LOCK TABLES `tt_incoming_payment` WRITE;
/*!40000 ALTER TABLE `tt_incoming_payment` DISABLE KEYS */;
INSERT INTO `tt_incoming_payment` VALUES (1,'',NULL,'',2000.00,NULL,'2017-09-09 11:01:50',NULL,1,1),(2,'',NULL,'MM WALLET',100.00,NULL,'2017-09-11 11:26:21',NULL,1,2);
/*!40000 ALTER TABLE `tt_incoming_payment` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_pin_import_config`
--

DROP TABLE IF EXISTS `tt_pin_import_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_pin_import_config` (
  ...
  CONSTRAINT `FKf7awqvinew3q6n7r1qqcdrq8v` FOREIGN KEY (`voucher_type_id`) REFERENCES `tt_voucher_type` (`voucher_type_id`),
  CONSTRAINT `FKavqxp2nlbbby9n9ltpdqbi2hf` FOREIGN KEY (`voucher_provider_id`) REFERENCES `tt_voucher_provider` (`voucher_provider_id`),
  CONSTRAINT `FKe74trnc1kjxdiq6stjj8snbio` FOREIGN KEY (`service_provider_id`) REFERENCES `tt_service_provider` (`service_provider_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_pin_import_config`
--

LOCK TABLES `tt_pin_import_config` WRITE;
/*!40000 ALTER TABLE `tt_pin_import_config` DISABLE KEYS */;
INSERT INTO `tt_pin_import_config` VALUES (1,'','AIRTEL_AIRTEL','','\0',2,3,'(\\d+),(\\d+),(\\d+),(.*)','\0','',NULL,2,'VOUCHER_BATCH_(\\d+)_(\\d+)',',',100,'yyyyMMdd','','\0',2,5,'(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(.*)','VOUCHER_BATCH_(\\d+)_(\\d+)',NULL,NULL,14,1,2,12,2,'','\0',1,1,'(\\d+),(\\d+),(.*)',1,1,1),(2,'','VODAFONE_VODAFONE','\0','',NULL,0,NULL,'\0','',NULL,2,'Voms(\\d+)_(\\d+).dec','##',100,NULL,'\0','\0',NULL,NULL,NULL,'Voms(\\d+)_(\\d+).dec',NULL,NULL,14,2,2,15,3,'','\0',1,1,'Total Vouchers=(\\d+),(.*)',4,4,1),(3,'','TIGO_TIGO','','\0',2,1,'FaceValue:(\\d+)','','\0',1,1,'Batch:(\\d+)',' ',10000,'yyyyMMdd','','\0',4,1,'StopDate:(\\d+)','(\\d+)K.txt',NULL,NULL,16,2,6,11,1,'\0','\0',NULL,NULL,NULL,5,5,1),(4,'','MTN_MTN','','\0',1,3,'(\\d+),(\\d+),(\\d+),(.*)','\0','',NULL,1,'(.*)_(.*)_(.*)_(.*)_(.*)',',',100,'yyyyMMdd','','\0',1,5,'(\\d+),(\\d+),(\\d+),(\\d+),(\\d+),(.*)','GHA(.*)','[T3raTech*PGPk3y]','mtn_pgp_private.key',13,1,1,10,2,'\0','\0',NULL,NULL,NULL,3,3,1);
/*!40000 ALTER TABLE `tt_pin_import_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_pinbased_voucher`
--

DROP TABLE IF EXISTS `tt_pinbased_voucher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_pinbased_voucher` (
...
--
-- Dumping data for table `tt_pos_machine`
--

LOCK TABLES `tt_pos_machine` WRITE;
/*!40000 ALTER TABLE `tt_pos_machine` DISABLE KEYS */;
INSERT INTO `tt_pos_machine` VALUES (1,'home','359128041055936','359128046055931','9648041533615379','9648045518450382','demo',NULL,NULL,2),(2,'t3ratech','359128041083821','359128046083826','9620010100331449','','fiademo',NULL,NULL,4);
/*!40000 ALTER TABLE `tt_pos_machine` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_service_provider`
--

DROP TABLE IF EXISTS `tt_service_provider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_service_provider` (
...
--
-- Dumping data for table `tt_service_provider`
--

LOCK TABLES `tt_service_provider` WRITE;
/*!40000 ALTER TABLE `tt_service_provider` DISABLE KEYS */;
INSERT INTO `tt_service_provider` VALUES (1,'','Airtel'),(2,'\0','Glo'),(3,'','MTN'),(4,'','Vodafone'),(5,'','Tigo'),(6,'\0','Multichoice'),(7,'','WAEC');
/*!40000 ALTER TABLE `tt_service_provider` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_voucher`
--

DROP TABLE IF EXISTS `tt_voucher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_voucher` (
  ...
  CONSTRAINT `FKdcy4bc6drdehrprko9sb5qsrn` FOREIGN KEY (`voucher_type_id`) REFERENCES `tt_voucher_type` (`voucher_type_id`),
  CONSTRAINT `FKcb6bvm0hy6su7bamohueptcf6` FOREIGN KEY (`voucher_provider_id`) REFERENCES `tt_voucher_provider` (`voucher_provider_id`),
  CONSTRAINT `FKm22bee8c3ye8kxh635nxl6a1r` FOREIGN KEY (`service_provider_id`) REFERENCES `tt_service_provider` (`service_provider_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_voucher`
--

LOCK TABLES `tt_voucher` WRITE;
/*!40000 ALTER TABLE `tt_voucher` DISABLE KEYS */;
INSERT INTO `tt_voucher` VALUES (1,'','','','GHS',8,1.00,1,1,1),(2,'','','','GHS',8,2.00,1,1,1),(3,'','','','GHS',8,5.00,1,1,1),(4,'','','','GHS',8,10.00,1,1,1),(5,'','','','GHS',8,20.00,1,1,1),(6,'','','','GHS',6.5,1.00,3,3,1),(7,'','','','GHS',6.5,2.00,3,3,1),(8,'','','','GHS',6.5,5.00,3,3,1),(9,'','','','GHS',6.5,10.00,3,3,1),(10,'','','','GHS',6.5,20.00,3,3,1),(11,'','','','GHS',10,1.00,4,4,1),(12,'','','','GHS',10,2.00,4,4,1),(13,'','','','GHS',10,5.00,4,4,1),(14,'','','','GHS',10,10.00,4,4,1),(15,'','','','GHS',10,20.00,4,4,1),(16,'','','','GHS',8,1.00,5,5,1),(17,'','','','GHS',8,2.00,5,5,1),(18,'','','','GHS',8,5.00,5,5,1),(19,'','','','GHS',8,10.00,5,5,1),(20,'','','','GHS',10,7.50,7,7,4);
/*!40000 ALTER TABLE `tt_voucher` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_voucher_provider`
--

DROP TABLE IF EXISTS `tt_voucher_provider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_voucher_provider` (
...
--
-- Dumping data for table `tt_voucher_provider`
--

LOCK TABLES `tt_voucher_provider` WRITE;
/*!40000 ALTER TABLE `tt_voucher_provider` DISABLE KEYS */;
INSERT INTO `tt_voucher_provider` VALUES (1,'','Airtel',NULL),(2,'\0','Glo',NULL),(3,'','MTN',NULL),(4,'','Vodafone',NULL),(5,'','Tigo',NULL),(6,'\0','CowryPay',NULL),(7,'','WAEC',NULL);
/*!40000 ALTER TABLE `tt_voucher_provider` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_voucher_purchase`
--

DROP TABLE IF EXISTS `tt_voucher_purchase`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_voucher_purchase` (
  ...
  CONSTRAINT `FKmoj1apivx0xmlgohti3vc67lb` FOREIGN KEY (`distribution_channel_id`) REFERENCES `tt_distribution_channel` (`distribution_channel_id`),
  CONSTRAINT `FKpth9u23cf7mmyb8tgplxgtmlt` FOREIGN KEY (`response_code_id`) REFERENCES `symbiosis_response_code` (`id`),
  CONSTRAINT `FKs5il4ptf8vrg02bdki4iptp31` FOREIGN KEY (`voucher_id`) REFERENCES `tt_voucher` (`voucher_id`),
  CONSTRAINT `FKt8hxq86l0jecvbrwk2wuex6s3` FOREIGN KEY (`pinbased_voucher_id`) REFERENCES `tt_pinbased_voucher` (`pinbased_voucher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_voucher_purchase`
--

LOCK TABLES `tt_voucher_purchase` WRITE;
/*!40000 ALTER TABLE `tt_voucher_purchase` DISABLE KEYS */;
INSERT INTO `tt_voucher_purchase` VALUES (1,'tsungai','\0',NULL,'2017-09-11 11:06:37',0.92,1.00,0.96,1,1,0,2,1,1,1),(2,'tsungai','\0',NULL,'2017-09-11 11:23:00',0.92,1.00,0.96,1,2,0,2,1,1,1),(3,'fiademo','\0',NULL,'2017-09-11 11:31:34',9.00,10.00,9.65,1,NULL,60,4,2,14,2),(4,'fiademo','\0',NULL,'2017-09-11 11:33:28',0.92,1.00,0.96,1,3,0,4,2,1,2),(5,'fiademo','\0',NULL,'2017-09-20 11:06:16',9.00,10.00,9.65,1,46,0,4,2,14,2),(6,'tsungai','\0',NULL,'2017-09-20 13:36:26',0.90,1.00,0.96,1,NULL,60,2,1,11,1),(7,'tsungai','\0',NULL,'2017-09-20 13:36:33',9.00,10.00,9.65,1,47,0,2,1,14,1),(8,'tsungai','\0',NULL,'2017-09-20 13:37:52',0.92,1.00,0.96,1,4,0,2,1,1,1),(9,'tsungai','\0',NULL,'2017-09-20 16:57:20',0.92,1.00,0.96,1,5,0,2,1,1,1),(10,'tsungai','\0',NULL,'2017-09-20 17:46:06',0.92,1.00,0.96,1,6,0,2,1,1,1);
/*!40000 ALTER TABLE `tt_voucher_purchase` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_voucher_status`
--

DROP TABLE IF EXISTS `tt_voucher_status`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_voucher_status` (
...
--
-- Dumping data for table `tt_voucher_status`
--

LOCK TABLES `tt_voucher_status` WRITE;
/*!40000 ALTER TABLE `tt_voucher_status` DISABLE KEYS */;
INSERT INTO `tt_voucher_status` VALUES (1,'','NEW'),(2,'','SOLD'),(3,'','EXPIRED');
/*!40000 ALTER TABLE `tt_voucher_status` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_voucher_type`
--

DROP TABLE IF EXISTS `tt_voucher_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_voucher_type` (
...
--
-- Dumping data for table `tt_voucher_type`
--

LOCK TABLES `tt_voucher_type` WRITE;
/*!40000 ALTER TABLE `tt_voucher_type` DISABLE KEYS */;
INSERT INTO `tt_voucher_type` VALUES (1,'','AIRTIME'),(2,'\0','INTERNET'),(3,'\0','DSTV'),(4,'\0','RESULT CHECKER PIN');
/*!40000 ALTER TABLE `tt_voucher_type` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tt_wallet_group_voucher`
--

DROP TABLE IF EXISTS `tt_wallet_group_voucher`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tt_wallet_group_voucher` (
  ...
  CONSTRAINT `FK7yjmoreac62wdfu1rvdpplk47` FOREIGN KEY (`voucher_id`) REFERENCES `tt_voucher` (`voucher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tt_wallet_group_voucher`
--

LOCK TABLES `tt_wallet_group_voucher` WRITE;
/*!40000 ALTER TABLE `tt_wallet_group_voucher` DISABLE KEYS */;
INSERT INTO `tt_wallet_group_voucher` VALUES (1,3.5,1,1),(2,3.5,2,1),(3,3.5,3,1),(4,3.5,4,1),(5,3.5,5,1),(6,3.5,6,1),(7,3.5,7,1),(8,3.5,8,1),(9,3.5,9,1),(10,3.5,10,1),(11,3.5,11,1),(12,3.5,12,1),(13,3.5,13,1),(14,3.5,14,1),(15,3.5,15,1),(16,3.5,16,1),(17,3.5,17,1),(18,3.5,18,1),(19,3.5,19,1),(20,3.5,20,1),(32,4,1,2),(33,4,2,2),(34,4,3,2),(35,4,4,2),(36,4,5,2),(37,4,6,2),(38,4,7,2),(39,4,8,2),(40,4,9,2),(41,4,10,2),(42,4,11,2),(43,4,12,2),(44,4,13,2),(45,4,14,2),(46,4,15,2),(47,4,16,2),(48,4,17,2),(49,4,18,2),(50,4,19,2),(51,4,20,2),(63,5,1,3),(64,5,2,3),(65,5,3,3),(66,5,4,3),(67,5,5,3),(68,5,6,3),(69,5,7,3),(70,5,8,3),(71,5,9,3),(72,5,10,3),(73,5,11,3),(74,5,12,3),(75,5,13,3),(76,5,14,3),(77,5,15,3),(78,5,16,3),(79,5,17,3),(80,5,18,3),(81,5,19,3),(82,5,20,3);
/*!40000 ALTER TABLE `tt_wallet_group_voucher` ENABLE KEYS */;
UNLOCK TABLES;
